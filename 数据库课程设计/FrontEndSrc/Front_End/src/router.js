...
import StudentEvaluateClass from "./views/student/StudentEvaluateClass";
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "/student/evaluate/class",
        name: "student-evaluate-class",
        component: StudentEvaluateClass,
      },
      {
        path: "/teacher",
        name: "teacher-home",
