...
func newClass(db *gorm.DB, opts ...gen.DOOption) class {
	...
	_class.ClassID = field.NewUint(tableName, "class_id")
	_class.ClassName = field.NewString(tableName, "class_name")
	_class.Grade = field.NewUint(tableName, "grade")
	_class.DepartmentName = field.NewString(tableName, "department_name")
	_class.MajorName = field.NewString(tableName, "major_name")
...
func (c *class) updateTableName(table string) *class {
	...
	c.ClassID = field.NewUint(table, "class_id")
	c.ClassName = field.NewString(table, "class_name")
	c.Grade = field.NewUint(table, "grade")
	c.DepartmentName = field.NewString(table, "department_name")
	c.MajorName = field.NewString(table, "major_name")
...
func (c *class) fillFieldMap() {
	...
	c.fieldMap["major_name"] = c.MajorName
}
