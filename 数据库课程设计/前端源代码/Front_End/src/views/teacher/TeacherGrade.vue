        ...
        <el-form :model="entityForm" label-width="70px" ref="form">
          <el-form-item label="选课Id">
            <el-input
              disabled
              type="number"
              v-model.number="entityForm.studentCourseId"
            ></el-input>
          </el-form-item>
          <el-form-item label="总成绩">
            <el-input
              type="number"
              v-model.number="entityForm.score">
            </el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    query() {
      api
        .getPageCount(this.queryForm.courseName, this.queryForm.studentName,this.pageSize)
        .then((res) => {
          this.pageCount = res;
          this.pageIndex = 1;
          this.getPage(1);
    ...
    edit(id) {
      console.log(id.studentCourseId);
      api.get(id.studentCourseId).then((res) => {
        this.entityForm = res;
        this.editing = true;
