...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.StudentID = field.NewUint(tableName, "student_id")
	_student.StudentName = field.NewString(tableName, "student_name")
	_student.DepartmentName = field.NewString(tableName, "department_name")
	_student.MajorName = field.NewString(tableName, "major_name")
	_student.ClassName = field.NewString(tableName, "class_name")
	_student.Email = field.NewString(tableName, "email")
	_student.Birthday = field.NewString(tableName, "birthday")
	_student.Sex = field.NewUint(tableName, "sex")
	_student.Password = field.NewString(tableName, "password")
...
func (s *student) updateTableName(table string) *student {
	...
	s.StudentID = field.NewUint(table, "student_id")
	s.StudentName = field.NewString(table, "student_name")
	s.DepartmentName = field.NewString(table, "department_name")
	s.MajorName = field.NewString(table, "major_name")
	s.ClassName = field.NewString(table, "class_name")
	s.Email = field.NewString(table, "email")
	s.Birthday = field.NewString(table, "birthday")
	s.Sex = field.NewUint(table, "sex")
...
func (s *student) fillFieldMap() {
	...
	s.fieldMap["department_name"] = s.DepartmentName
	s.fieldMap["major_name"] = s.MajorName
	s.fieldMap["class_name"] = s.ClassName
