...
func newMajor(db *gorm.DB, opts ...gen.DOOption) major {
	...
	_major.MajorID = field.NewUint(tableName, "major_id")
	_major.MajorName = field.NewString(tableName, "major_name")
	_major.DepartmentName = field.NewString(tableName, "department_name")
...
func (m *major) updateTableName(table string) *major {
	...
	m.MajorID = field.NewUint(table, "major_id")
	m.MajorName = field.NewString(table, "major_name")
	m.DepartmentName = field.NewString(table, "department_name")
...
func (m *major) fillFieldMap() {
	...
	m.fieldMap["major_id"] = m.MajorID
	m.fieldMap["major_name"] = m.MajorName
	m.fieldMap["department_name"] = m.DepartmentName
}
